namespace MoogleEngine
{
    public class Query
    {
        ...
        public HashSet<string> Mustbe_operator { get; private set; }
        public HashSet<string> Mustnotbe_operator { get; private set; }
        ...
        public Query(string search)
        {
            ...
            this.Mustbe_operator = new HashSet<string>();
            this.Mustnotbe_operator = new HashSet<string>();
        ...
        void check_operators(string query)
        {
            for (int i = 0; i < query.Length; i++)
            {
                ...
                else if (query[i] == '!')
                {
                    ...
                    Mustnotbe_operator.Add(temp.Item1);
                    i = temp.Item2;
                    continue;
                }
                ...
                {
                    (string, int) temp = StringMethods.Next_Word(query, i + 1);
                    Mustbe_operator.Add(temp.Item1);
                    i = temp.Item2;
                    continue;
                }
