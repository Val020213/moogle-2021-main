...
namespace MoogleEngine
{
    public class Vector
    {
        Dictionary<string, WordInfo> Components;
        public Dictionary<string, WordInfo> get_Components { get { return Components; } }
        ...
        {//Cos con el calculo del producto punto, y verificar las condiciones
            ...
            Dictionary<string, bool> Must_be = queryInfo.get_Mustbe_operator;
            Dictionary<string, bool> Must_not = queryInfo.get_Mustnotbe_operator;
            Dictionary<string, double> Important = queryInfo.get_Important_operator;
            ...
            {
                score_query = VQuery.Components[Component].get_tf_idf_score;
                ...
                {   
                    ...
                    score_doc = Doc.Components[Component].get_tf_idf_score;
